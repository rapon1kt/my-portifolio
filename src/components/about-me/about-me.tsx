		...
		<section id="about-me">
			<div className="left-corner">
				...
				<Typography className="my-description">
					...
					currently studying at the Federal University of Itajubá (UNIFEI). I'm
					a technology enthusiast with a positive mindset and a wild desire to
					learn new things. Since beginning my journey as a Front-End Student, I
					have continuously worked to improve my skills and optimize my projects
					more and more.
					<br /> <br />
